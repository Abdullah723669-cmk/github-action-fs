...
SVC_NAME="actions.runner.Abdullah723669-cmk-github-action-fs.kali.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Abdullah723669-cmk-github-action-fs.kali)"
